...
class Location(BaseModel):
    ...
    floor_level: int | None = Field(default=None, description="Floor level of the real estate (if there is any).")
    total_floor_levels: int | None = Field(
        default=None,
...
class State(BaseModel):
    ...
    new_building: bool | None = Field(description="If the real estate is new, then this mut be true.")
    built_year: int | None = Field(description="Year when the property was built.")
    reconstructed_year: int | None = Field(description="Year when the property was last reconstructed.")
...
class RealEstate(BaseModel):
    ...
    additional_fees: bool | None = Field(
